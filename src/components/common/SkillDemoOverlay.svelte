...
{#if isVisible && selectedTech}
  <div
    class="h-full bg-card/95 backdrop-blur-md rounded-2xl flex flex-col p-6 border border-border"
  >
    ...
    <div class="space-y-4 text-left flex-1 overflow-y-auto min-h-0 pr-2">
    ...
    <button
      onclick={onClose}
      class="mt-6 flex-shrink-0 w-full py-2.5 px-4 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-colors text-sm font-medium shadow-sm"
    >
